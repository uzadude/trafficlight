...
if runner.traci.isEmbedded():
    ...
    runner.generate_routefile(options.seed, options.steps, options.avg_time)
    ...
    retCode = subprocess.call([sumoBinary, "-c", "data/simple_cross/cross.sumocfg", "--python-script", __file__],
